...
class Ui_login(object):
    def setupUi(self, login):
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(180, 170, 75, 23))
        ...
        self.label_2.setGeometry(QtCore.QRect(50, 120, 41, 16))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(11)
        ...
        self.textEdit.setGeometry(QtCore.QRect(100, 60, 141, 31))
        self.textEdit.setObjectName("textEdit")
        self.textEdit_2 = QtWidgets.QTextEdit(login)
        self.textEdit_2.setGeometry(QtCore.QRect(100, 110, 141, 31))
